...
print_char("o                              o")
print_char("o THANKS TO ANDREW MOORE       o")
print_char("o  FOR LOANING THE GAME PCB    o")
print_char("o                              o")
...
print_char("o      SUV                     o")
print_char("o                              o")
print_char("oXZARIAN      - M. ASTUDILLO   o")
print_char("oANDYWAYS     - TOBY BOREHAM   o")
print_char("oRYAN FIG     - ULTRAROBOTNINJAo")
print_char("oKYLE GOOD    - VICTOR GOMARIZ o")
print_char("oLESLIE LAW   - JORGE SLOWFRET o")
print_char("oDON GAFFORD  - STEVEN WILSON  o")
print_char("oROMAN BUSER  - OSCAR LAGUNA   o")
print_char("oMARY MARSHALL- MATTHEW YOUNG  o")
print_char("oOLIVER JAKSCH- OLIVER WNDMTH  o")
print_char("o                              o")
print_char("o                              o")
print_char("o                              o")
print_char("o                              o")
